'''
Modified API wrapper from
https://github.com/bycoffe/python-wmata/blob/master/pywmata.py
...
if __name__ == "__main__":
    ...
    apikey = 'f19a156811e749d690033de5800b0c4f'
    choochoo = Wmata(apikey)
    print(choochoo.stations('RD'))
